...
local function AddDraggingFunctionality(DragPoint, Main)
    ...
    local function StartDrag(Input)
        ...
        local function EndDrag(ChangedInput)
            if ChangedInput.UserInputState == Enum.UserInputState.End then
                Dragging = false
                if DragInput and DragInput.Changed then
    ...
    DragPoint.InputChanged:Connect(function(Input)
        if (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) and Dragging then
            ...
            TweenService:Create(Main, TweenInfo.new(0.1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { Position = NewPosition }):Play()
        end
    end)
end
